...
const games = [
  {
    ...
    category: "Fighting",
    description:
      "The latest in the legendary fighting game series with stunning graphics and new mechanics.",
  ...
  },
  {
    ...
    category: "VR",
    description:
      "Slice beats with lightsabers in this immersive rhythm VR experience.",
  ...
  },
  {
    ...
    category: "Rhythm",
    description:
      "Step to the beat in this classic dance rhythm game with the latest songs.",
  ...
  },
  {
    ...
    category: "Shooter",
    description:
      "Fast-paced light gun shooter with cinematic action sequences.",
  ...
  },
  {
    ...
    category: "Classic",
    description:
      "The classic maze game reimagined with modern twists and power-ups.",
  ...
  },
  {
    ...
    category: "Pinball",
    description:
      "Medieval-themed pinball with castle destruction and multiball madness.",
  ...
  },
  {
    ...
    category: "Fighting",
    description:
      "The newest entry in the King of Iron Fist Tournament with stunning visuals.",
  ...
  },
  {
    ...
    category: "VR",
    description:
      "Immersive VR adventure in the Half-Life universe with puzzle-solving action.",
...
export default function GamesPage() {
  ...
  const filteredGames = games.filter((game) => {
    ...
    const matchesAvailability =
      availabilityFilter === "all" || game.availability === availabilityFilter;
      ...
      <div className="flex flex-1 flex-col gap-6 p-4 pt-0">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Reserve your spot on our premium arcade games. Choose from classic
            favorites to cutting-edge VR experiences.
          </p>
        </div>
            ...
            >
              <div className="aspect-video relative">
                ...
                <div className="absolute top-2 right-2">
                  {getAvailabilityBadge(game.availability)}
                </div>
              ...
              <CardContent className="pt-0 space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    className="flex-1"
                    disabled={game.availability === "maintenance"}
                  >
